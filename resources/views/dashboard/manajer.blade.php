...
<div class="space-y-6">
    ...
    <div>
        <h1 class="text-2xl font-bold text-gray-800">Tim {{ Str::before(auth()->user()->name, ' ') }}</h1>
        <p class="text-sm text-gray-400 mt-1">{{ now()->translatedFormat('l, d F Y') }} · {{ $staff->count() }} anggota tim</p>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        @include('dashboard._corong', ['judul' => 'Corong tim'])
    </div>
